...
// {"rotation":{"x":1.31,"y":0}} end open
// {"rotation":{"x":3.1345446777343478,"y":0.12727272033691403}} start closed
export function MacBook(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[-0.1, 0.52, 1]} rotation={[rotation.x,rotation.y,0]}scale={0.1}>
