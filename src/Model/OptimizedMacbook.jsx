...
Command: npx gltfjsx@6.1.4 optimizedMacbook.glb
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function OptimizedMacbook(props) {
  const { nodes, materials } = useGLTF('/optimizedMacbook.glb')
  return (
...
useGLTF.preload('/optimizedMacbook.glb')
